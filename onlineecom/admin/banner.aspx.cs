...
namespace onlineecom.admin
{
    public partial class banner : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Config.q = "select * from banner where deleted_at IS NULL order by id desc";
            ...
            if (Request.QueryString["type"] != null)
            {
                ...
                if (type.Equals("status"))
                {
                    ...
                    string update_status_sql = "update banner set status='" + status.ToString() + "' where id='" + id.ToString() + "'";
                ...
                if (type == "delete")
                {
                    ...
                    string id = Request.QueryString["id"].ToString();
                    string delete_sql = "update banner set deleted_at='"+dateTime+"' where id='" + id + "'";
