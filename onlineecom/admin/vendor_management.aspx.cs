...
{
    public partial class vendor_management : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Config.q = "select * from admin_users where role='1' and admin_users.deleted_at IS NULL order by id desc;";
            ...
            if (Request.QueryString["type"] != null)
            {
                ...
                if (type.Equals("status"))
                {
                    ...
                    string update_status_sql = "update admin_users set status='" + status.ToString() + "' where id='" + id.ToString() + "'";
                ...
                if (type == "delete")
                {
                    ...
                    string id = Request.QueryString["id"].ToString();
                    string delete_sql = "update admin_users set deleted_at='"+dateTime+"' where id='" + id + "'";
