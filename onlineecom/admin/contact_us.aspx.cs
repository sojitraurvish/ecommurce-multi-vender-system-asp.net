...
namespace onlineecom.admin
{
    public partial class contact_us : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Config.q = "select * from contact_us where contact_us.deleted_at IS NULL order by id desc";
            ...
            if (Request.QueryString["type"] != null)
            {
                ...
                if (type == "delete")
                {
                    ...
                    string delete_sql = "update contact_us set deleted_at='"+dateTime+"' where id='" + id + "'";
