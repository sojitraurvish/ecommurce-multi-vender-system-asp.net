<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="onlineecom.admin.users" %>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a id="deleteCategories" onclick='myFunction()' href = "users.aspx?type=delete&id=<%#Eval("id") %>" class="badge badge-danger hand_cursor">Delete</a>&nbsp;
